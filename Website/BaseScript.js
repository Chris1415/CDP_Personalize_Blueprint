<script type="text/javascript">
    ...
    var _boxever_settings = {
        client_key: '[YOUR_CLIENTKEY]', // Replace with your client key
        target: 'https://api.boxever.com/v1.2', // Replace with your API target endpoint specific to your data center region
        cookie_domain: '*.[YOUR_DOMAIN].com/', // Replace with the top level cookie domain of the website that is being integrated e.g ".example.com" and not "www.example.com"
	pointOfSale: "[YOUR_POS]",  // Replace with your POS
	...
	function View() {
        ...
        var viewEvent = {
            ...
            "pos": "[YOUR_POS]",  // Replace with your POS
            "session_data": {
